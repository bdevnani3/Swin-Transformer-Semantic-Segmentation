...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
                 ...
                 act_layer=nn.GELU, norm_layer=nn.LayerNorm, attention_type='window'):
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 ...
                 approach_args={}, attention_type='window'):
...
class OurSwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=512, patch_size=4, in_chans=3, num_classes=1000,
        ...
        for i_layer in range(self.num_layers):
            layer = BasicLayer(
                ...
                attention_type='reversed_window' if i_layer in reverse_attention_locations else 'window'
            )
    ...
    def flops(self):
        ...
        for i, layer in enumerate(self.layers):
            flops += layer.flops()
        flops += self.num_features_int * self.patches_resolution[0] * self.patches_resolution[1] // (2 ** self.num_layers)
